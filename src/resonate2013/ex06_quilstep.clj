...
(defn make-key
  "Take a note id (0..11) and color, calls `make-button` with predefined
  handler to switch pitch of wobble bass in currently playing syth instance."
  [[n col]]
  (let [col (* 255 col)]
...
;; declare the presence of the `sliders` symbol define below
(declare sliders)
